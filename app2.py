            ...
            for cam in cam_manager.get_frames():
                ...
                if found_markers:
                    for marker in markers:
                        ...
                        cv2.putText(img, str(marker.id), (int(marker.x), int(marker.y)), cv2.FONT_HERSHEY_SIMPLEX, 0.5,
                                    (255, 255, 255), 1)
...
cam_manager = CamManager([
    ...
    IPCam("http://192.168.8.103:8080/",
          data_filename="C:\\Users\\sipho_000\\PycharmProjects\\PositionEstimation\\camera2\\LG_K8.npz", name="LG_K8"),
    # IPCam("http://192.168.8.101:8080/", data_filename="C:\\Users\\sipho_000\\PycharmProjects\\PositionEstimation\\camera2\\huawei_y560.npz", name="huawei_y560"),
    # IPCam("http://192.168.8.100:8080/", data_filename="C:\\Users\\sipho_000\\PycharmProjects\\PositionEstimation\\camera2\\huawei_y220.npz", name="huawei_y220")
    # IPCam("http://192.168.8.106:8080/", data_filename="C:\\Users\\sipho_000\\PycharmProjects\\PositionEstimation\\camera2\\samsung_galaxy.npz", name="samsung_galaxy")
])
cam_manager.start()

# sensor = CameraSensors("http://192.168.8.100:8080/")
...
while True:
    ...
    """if sensor.get_sensor("pitch"):
        all_data["pitch"] = sensor.get_sensor("pitch").value
    else:
        all_data["pitch"] = 0
    if sensor.get_sensor("roll"):
        all_data["roll"] = sensor.get_sensor("roll").value
    else:
        all_data["roll"] = 0"""
    ...
    if cv_thread.quit or command == "quit":
        break
